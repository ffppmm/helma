 ...
 * It is constructed from the logical table (type) name and the column
 * name/column value pairs that identify the key's object
 * 
...
public final class MultiKey implements Key, Serializable {
	...
	/**
	 * Make a key for a persistent Object, describing its datasource and key
	 * parts.
	 */
	 ...
	 * This is necessary to implement references to unspecified prototype
	 * targets.
	 * 
	 * @param dbmap
	 *            the nominal/static dbmapping
	 * @param parts
	 *            the parts map
	 * @return the actual dbmapping name
	 */
	private String getStorageNameFromParts(DbMapping dbmap,
	...
	public boolean equals(Object what) {
		...
		// storageName is an interned string (by DbMapping, from where we got
		// it)
	...
	public int hashCode() {
		if (hashcode == 0) {
			hashcode = (storageName == null) ? (17 + (37 * parts.hashCode()))
					: (17 + (37 * storageName.hashCode()) + (+37 * parts
							.hashCode()));
		}
	...
	public String toString() {
		return (storageName == null) ? ("[" + parts + "]") : (storageName + "["
				+ parts + "]");
	}
