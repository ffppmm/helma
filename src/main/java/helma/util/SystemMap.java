...
/**
 * Map class used internally by Helma. We use this class to be able to wrap maps
 * as native objects within a scripting engine rather than exposing them through
 * Java reflection.
 */
public class SystemMap extends HashMap<String, Object> {
	...
	/**
	 * @return A String representation of this map. The returned string is
	 *         similar to the one returned by java.util.HashMap.toString(), but
	 *         additionally displays Object arrays in a human friendly way.
	 */
