...
public class StringUtils {
	...
	/**
	 * Split a string into an array of strings. Use comma and space as
	 * delimiters.
	 */
	...
	/**
	 * Get the character array for a string. Useful for use from Rhino, where
	 * the Java String methods are not readily available without constructing a
	 * new String instance.
	 * 
	 * @param str
	 *            a string
