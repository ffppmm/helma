...
/**
 * This is the internal key for an object that is not - or not directly -
 * fetched from a db, but derived from another object. This is useful for all
 * kinds of object accessed via a symbolic name from another object, like
 * objects mounted via a property name column, virtual nodes and groupby nodes.
 */
public final class SyntheticKey implements Key, Serializable {
	...
	/**
	 * Make a symbolic key for an object using its parent key and its property
	 * name/id.
	 * 
	 * @param key
	 *            the parent key
	...
	/**
	 * Get the storage name for this key. This alwys returns null for symbolic
	 * keys.
	 * 
	 * @return null
	 */
