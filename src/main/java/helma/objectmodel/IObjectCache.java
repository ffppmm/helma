...
public interface IObjectCache {
	...
	/**
	 * Set the {@link helma.framework.core.Application Application} instance for
	 * the cache.
	 * 
	 * @param app
	 *            the app instance
	...
	/**
	 * Called when the application's properties have been updated to let the
	 * cache implementation update its settings.
	 * 
	 * @param props
	 */
	...
	/**
	 * Returns the number of keys in object array <code>keys</code> that were
	 * not found in the Map. Those keys that are contained in the Map are nulled
	 * out in the array.
	 * 
	 * @param keys
	 *            an array of key objects we are looking for
	 * @see IObjectCache#containsKey
	 */
