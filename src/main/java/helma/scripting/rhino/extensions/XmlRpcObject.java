...
/**
 * An extension to transparently call and serve XML-RPC from Rhino. The
 * extension adds constructors for XML-RPC clients and servers to the Global
 * Object.
 * 
...
public class XmlRpcObject extends BaseFunction {
	...
	public static Object xmlrpcObjectConstructor(Context cx, Object[] args,
		...
		if (args.length == 0 || args.length > 2) {
			throw new IllegalArgumentException(
					"Wrong number of arguments in constructor for XML-RPC client");
		}
		if (args.length == 1) {
	...
	public static void init(Scriptable scope) {
		...
		ScriptableObject.defineProperty(scope, "Remote", ctor,
