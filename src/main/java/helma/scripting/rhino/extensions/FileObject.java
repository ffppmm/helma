...
public class FileObject extends ScriptableObject {
	...
	public static FileObject fileObjCtor(Context cx, Object[] args,
		...
		if (args.length == 0 || args[0] == Undefined.instance) {
			throw new IllegalArgumentException(
					"File constructor called without argument");
		}
	...
	public static void init(Scriptable scope) {
		...
		String[] fileFuncs = { "toString", "getName", "getParent",
				"isAbsolute", "write", "remove", "list", "flush", "writeln",
				"close", "getPath", "open", "error", "canRead", "canWrite",
				"exists", "getAbsolutePath", "getLength", "isDirectory",
				"isFile", "lastModified", "mkdir", "renameTo", "eof",
				"isOpened", "readln", "clearError", "readAll" };
		try {
