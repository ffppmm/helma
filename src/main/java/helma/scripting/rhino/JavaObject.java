...
public class JavaObject extends NativeJavaObject {
	 ...
	 */
	public JavaObject(Scriptable scope, Object obj, String protoName,
			Scriptable prototype, RhinoCore core) {
		this.parent = scope;
		this.javaObject = obj;
	...
	public Object href(Object action, Object params)
		...
		String basicHref = core.app.getNodeHref(javaObject, actionName,
				queryParams);
