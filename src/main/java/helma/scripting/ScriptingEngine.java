...
/**
 * This is the interface that must be implemented to make a scripting
 * environment usable by the Helma application server.
 * 
 * Implementations of this interface must have a public zero-argument
 * constructor to be usable by the Helma framework.
 */
public interface ScriptingEngine {

	/**
	 * Argument wrapping mode that indicates arguments are wrapped already and
	 * should be passed along unchanged.
	 */
	public final int ARGS_WRAP_NONE = 0;

	/**
	 * Argument wrapping mode that indicates arguments may be arbitrary Java
	 * objects that may need to be wrapped.
	 */
	 ...
	 * is entered to let the Engine know it should update its prototype
	 * information
	 * 
	 * @throws IOException
