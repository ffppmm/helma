...
/**
 * Helma command line runner class. This class creates and starts a single
 * application, invokes a function in, writes its return value to the console
 * and exits.
 * 
...
public class CommandlineRunner {
	...
	/**
	 * boot method for running a request from the command line. This retrieves
	 * the Helma home directory, creates the app and runs the function.
	 * 
	 * @param args
	...
	public static void printUsageError() {
		...
		System.out.println("");
		System.out
				.println("Usage: java helma.main.launcher.Commandline [options] [appname].[function] [argument-list]");
		System.out.println("");
