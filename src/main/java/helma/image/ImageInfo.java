...
public class ImageInfo {
	...
	/**
	 * never used !!! private void synchBits() { bitBuf = 0; bitPos = 0; }
	 * 
	 * private String readLine(int firstChar) throws IOException { StringBuffer
	 * result = new StringBuffer(); result.append((char)firstChar); return
	 * readLine(result); }
	 */
