...
public class RequestBean implements Serializable {
	 ...
	 * of the Helma pseudo methods defined in RequestTrans.
	 */
	...
	/**
	 * @return the req.queryParams map containing parameters parsed from the
	 *         query string
	 * 
	 *         FIXME: Don't know what to do with functions that don't have Types
	 */
	...
	/**
	 * The action handler allows the onRequest() method to set the function
	 * object to be invoked for processing the request, overriding the action
