...
public class ResponseBean implements Serializable {
	...
	/**
	 * Write an object to the response buffer by converting it to a string and
	 * then HTML-encoding it.
	 * 
	 * @param obj
	...
	/**
	 * Write an object to the response buffer by converting it to a string and
	 * then encoding it for form/text area content use.
	 * 
	 * @param obj
	 *            the object to write to the response buffer
	 */
	...
	/**
	 * Returns the ServletResponse instance for this Response. Returns null for
	 * internal and XML-RPC requests.
	 * 
	...
	/**
	 * Set a HTTP cookie with the name and value that is discarded when the HTTP
	 * client is closed
	 * 
	 * @param key
	 *            the cookie name
	...
	/**
	 * Set a HTTP cookie with the name and value that is stored by the HTTP
	 * client for the given number of days. A days value of 0 means the cookie
	...
	/**
	 * Set a HTTP cookie with the name and value that is only applied to the
	 * URLs matching the given path and is stored by the HTTP client for the
	 * given number of days. A days value of 0 means the cookie should be
	...
	/**
	 * Unset a previously set HTTP cookie, causing it to be discarded
	 * immedialtely by the HTTP client.
	 * 
	 * @param key
	...
	/**
	 * Directly write a string to the response buffer without any
	 * transformation.
	 * 
	 * @param str
	...
	/**
	 * Write string to response buffer and append a platform dependent newline
	 * sequence.
	 * 
	 * @param str
	 *            the string to write to the response buffer
	...
	/**
	 * Directly write a byte array to the response buffer without any
	 * transformation.
	 * 
	 * @param bytes
	 *            the string to write to the response buffer
	 ...
	 * 
	 * @return true if the response may be cached by the HTTP client, false
	 *         otherwise
	 */
	 ...
	 * 
	 * @param cache
	 *            true if the response may be cached by the HTTP client, false
	 *            otherwise
	 */
	...
	/**
	 * Add an item to this response's dependencies. If no dependency has changed
	 * between requests, an HTTP not-modified response will be generated.
	 * 
	 * @param what
	...
	/**
	 * Digest this response's dependencies to conditionally create a HTTP
	...
	/**
	 * Push a string buffer on the response object. All further writes will be
	 * redirected to this buffer.
	 */
	public void push() {
		res.pushBuffer(null);
	}
	...
	/**
	 * Pop a string buffer from the response object containing all the writes
	 * since the last pushBuffer
	 * 
	 * @return ...
	 */
	public String pop() {
	...
	/**
	 * Commit changes made during the course of the current transaction and
	 * start a new one
	 * 
	 * @throws Exception
	...
	/**
	 * Rollback the current database transaction and abort execution. This has
	 * the same effect as calling rollback() and then stop().
	 * 
