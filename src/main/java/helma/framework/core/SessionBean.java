...
/**
 * The SessionBean wraps a <code>Session</code> object and exposes it to the
 * scripting framework.
 */
public class SessionBean implements Serializable {
	 ...
	 * If username and password match, the user node is associated with the
	 * session and bound to the session.user property.
	 * 
	 * @param username
	 *            the username
	 * @param password
	 *            the password
	 * 
	 * @return true if the user exists and the password matches the user's
	 *         password property.
	 */
	...
	/**
	 * Directly associates the session with a user object without requiring a
	 * username/password pair. This is for applications that use their own
	...
	/**
	 * Disassociate this session from any user object it may have been
	 * associated with.
	 */
	public void logout() {
		session.logout();
	 ...
	 * Usually, sessions are touched when the user associated with it sends a
	 * request. This method may be used to artificially keep a session alive.
	 */
	public void touch() {
		session.touch();
	}
	...
	/**
	 * Get the cache/data node for this session. This object may be used to
	 * store transient per-session data. It is reflected to the scripting
	...
	/**
	 * Gets the date at which the session was created or a login or logout was
	 * performed the last time.
	 * 
	 * @return ...
	 */
	...
	/**
	 * Sets the date at which the session was created or a login or logout was
	 * performed the last time.
	 * 
	 * @param date
	 *            ...
