...
public class RequestPath {
	 ...
	 * 
	 * @param id
	 *            the item id representing the path in the URL
	 * @param obj
	...
	/**
	 * Checks if the given object is contained in the request path. It returns
	 * the zero-based index position, or -1 if it isn't contained.
	 * 
	 * @param obj
	...
	/**
	 * Checks if the given object is contained in the request path. Itreturns
	 * the zero-based index position, or -1 if it isn't contained.
	 * 
	 * @param obj
	 *            the element to check
