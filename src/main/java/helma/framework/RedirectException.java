...
/**
 * RedirectException is thrown internally when a response is redirected to a new
 * URL. Although this is not an Error, it subclasses java.lang.Error because
 * it's not meant to be caught by application code (similar to
