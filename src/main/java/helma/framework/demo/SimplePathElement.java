...
/**
 * This is an example implementation for the helma.framework.IPathElement
 * interface. It creates any child element which is requested on the fly without
 * ever asking.
 */
public class SimplePathElement implements IPathElement {
	 ...
	 * This will be "root" for the root element and "hopobject for everything
	 * else.
	 */
