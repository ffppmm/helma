...
public class ResourceComparator implements Comparator<Object> {
	...
	public int compare(Object obj1, Object obj2) {
		...
		if (rep1 == rep2 || (pos1 == -1 && pos2 == -1)) {
			// Same root repository, but we must not return 0 unless objects are
			// equal
	...
	/**
	 * Checks if the comparator is equal to the given comparator A
	 * ResourceComparator is equal to another ResourceComparator if the
