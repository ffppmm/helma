...
public final class ZipResource extends AbstractResource {
	...
	protected ZipResource(String zipentryName, ZipRepository repository) {
		...
		baseName = (lastDot == -1) ? shortName : shortName
				.substring(0, lastDot);
	}
	...
	public InputStream getInputStream() throws IOException {
		...
		try {
			...
			if (entry == null) {
				throw new IOException("Zip resource " + this
						+ " does not exist");
			}
	...
	public String getContent(String encoding) throws IOException {
		...
		try {
			...
			in.close();
			return encoding == null ? new String(buf) : new String(buf,
					encoding);
		} finally {
			if (zipfile != null) {
				zipfile.close();
	...
	public URL getUrl() {
		...
		throw new UnsupportedOperationException(
				"getUrl() not implemented for ZipResource");
	}
	...
	public boolean equals(Object obj) {
		return obj instanceof ZipResource
				&& name.equals(((ZipResource) obj).name);
	}
