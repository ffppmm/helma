...
public class FileRepository extends AbstractRepository {
	...
	/**
	 * Updates the content cache of the repository Gets called from within all
	 * methods returning sub-repositories or resources
	 */
	public synchronized void update() {
		...
		if (directory.lastModified() != lastModified) {
			...
			ArrayList<Repository> newRepositories = new ArrayList<Repository>(
					list.length);
	...
	public String toString() {
		return new StringBuffer("FileRepository[").append(name).append("]")
				.toString();
	}
}
