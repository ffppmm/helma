...
public class SingleFileRepository implements Repository {
	...
	/**
	 * Checksum of the repository and all its content. Implementations should
	 * make sure
	 * 
	 * @return checksum
	...
	/**
	 * Returns this repository's parent repository. Returns null if this
	 * repository already is the top-level repository
	 * 
	...
	public boolean equals(Object obj) {
		return (obj instanceof SingleFileRepository && res
				.equals(((SingleFileRepository) obj).res));
	}
	...
	public String toString() {
		return new StringBuffer("SingleFileRepository[").append(res.getName())
				.append("]").toString();
	}
	...
	class FakeGlobal implements Repository {
		 ...
		 * repository from a scripting point of view. For example, a zip file
		 * within a file repository is not a root repository from a physical
		 * point of view, but from the scripting point of view it is.
		 * 
		 * @return true if the repository is to be considered a top-level script
		 *         repository
		 */
