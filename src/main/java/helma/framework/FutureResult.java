...
public interface FutureResult {
	/**
	 * Get the result of the execution. If the execution is still active, or if
	 * the invocation threw an exception, this method immediately returns null.
	 * 
	 ...
	 * is still active, or if no exception was thrown, this method immediately
	 * returns null.
	 * 
	...
	/**
	 * Wait for execution to terminat, returning the execution result, if one is
	 * available.
	 * 
	...
	/**
	 * Wait for a specific ammount of thime for the execution to terminate,
	 * returning the execution result, if one is available.
	 * 
	 * @param timeout
